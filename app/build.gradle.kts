...
dependencies { implementation(project(":virtual-runtime-api")); implementation(project(":core")); implementation(project(":virtual-storage")); implementation(project(":virtual-package-manager")); implementation(project(":virtual-file-manager")); implementation(project(":virtual-process")); implementation(project(":compat-android15")); implementation(libs.androidx.core); implementation(libs.activity.compose); implementation(libs.androidx.fragment.ktx); implementation(libs.androidx.lifecycle.runtime.ktx); implementation(platform(libs.compose.bom)); implementation(libs.compose.ui); implementation(libs.compose.foundation); implementation(libs.compose.material3); implementation(libs.compose.material3.window); implementation(libs.compose.preview); implementation(libs.nav.compose); implementation(libs.coroutines.android); implementation(libs.room.runtime); implementation(libs.room.ktx); implementation(libs.datastore.preferences); implementation(libs.biometric); implementation("net.dongliu:apk-parser:2.6.10"); ksp(libs.room.compiler); testImplementation(libs.junit); androidTestImplementation(libs.junit); androidTestImplementation("androidx.test:core:1.6.1"); androidTestImplementation("androidx.test:runner:1.6.2") }
