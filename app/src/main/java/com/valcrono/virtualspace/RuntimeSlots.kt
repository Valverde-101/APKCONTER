...
open class RuntimeProcessService : Service() {
    ...
    private fun startSession(req: RuntimeLaunchRequest): RuntimeIpcResult = guarded("START_FAILED") {
        ...
        adapter = runtimeAdapterFor(launchPkg); running = adapter!!.start(launchPkg); lastPhase = "CLASSLOADER_READY"; trace(req, "CLASSLOADER_READY", "LOAD_REQUEST_SENT", "LOAD_REQUEST_SENT", true)
