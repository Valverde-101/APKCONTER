...
enum class RuntimeSlotState { FREE, RESERVED, PROCESS_STARTING, SERVICE_CONNECTED, LOAD_REQUEST_SENT, CLASSLOADER_READY, ACTIVITY_STARTING, ACTIVE_FOREGROUND, ACTIVE_BACKGROUND, OCCUPIED, STOPPING, FAILED, STARTING, STOPPED, CRASHED, ERROR, RECOVERING, ADOPTING, PAUSED_BY_USER }
