...
data class ApkArchiveFactsV1(val packageName: String, val isIntegrityVerified: Boolean, val supportedAbis: List<String>, val detectedFramework: String)
