...
fun deriveRuntimeEffectiveState(
    ...
    val liveMatches = liveService != null &&
        ...
        liveService.virtualPackageName != null &&
        session != null &&
        slot != null &&
        liveService.sessionId == session.sessionId &&
        liveService.slotId == slot.slotId &&
        liveService.virtualPackageName == session.packageName &&
        liveService.pid > 0 &&
    ...
    val trulyActive = session != null && slot != null && slotActive && slotFresh &&
        ...
        slot.binderAlive && slot.runtimeGeneration == RuntimeHostRegistry.runtimeGeneration
