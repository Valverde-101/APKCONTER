...
class ActiveAckContainsSlotPidTest { @Test fun ackUsesMemoryPid() { assertTrue(source("app/src/main/java/com/valcrono/virtualspace/ProxyActivity.kt").contains("SESSION_ACTIVE_ACK_")) } }
...
class BackgroundActivityDoesNotStopRuntimeTest { @Test fun pauseIsBackgroundHeartbeat() { assertTrue(source("app/src/main/java/com/valcrono/virtualspace/ProxyActivity.kt").contains("sendHeartbeat(\"ACTIVE_BACKGROUND\")")) } }
