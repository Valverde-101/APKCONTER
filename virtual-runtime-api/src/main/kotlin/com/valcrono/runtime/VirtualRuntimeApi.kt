...
data class VirtualMessage(val id: String, val fromPackage: String, val toPackage: String, val type: String, val payload: String, val state: String = "PENDING")
...
interface VirtualMessageApi { fun send(toPackage: String, type: String, payload: String): String; fun pending(): List<VirtualMessage>; fun markDelivered(messageId: String) }
